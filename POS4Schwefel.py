...
def pso_update(X, V, pbest, pbest_obj, gbest, gbest_obj):
...
if __name__ == "__main__":
    ...
    def animate(i):
        ...
        X, V, pbest, pbest_obj, gbest, gbest_obj = pso_update(X, V, pbest, pbest_obj, gbest, gbest_obj)
        # Set picture
        ax.set_title(title)
